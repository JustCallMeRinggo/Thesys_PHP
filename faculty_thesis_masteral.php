        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
           <li><a href="faculty_thesis_undergraduate.php"><i class="fa fa-graduation-cap"></i> Undergraduate</a></li>
            <li class="active"><a href="faculty_thesis_masteral.php"><i class="fa fa-industry"></i> Masteral</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 text-right">
          <div class="input">
            <form action="faculty_thesis_masteral.php" method="post">
    ...
    <section class="content container-fluid">
      <table class="table table-bordered" style="width:100%;">
              ...
              -->
                <td>
                  <a href="faculty_viewThesis_masteral.php?thesis_id=<?php echo $rowTheses['thesis_id']?>" class="btn btn-sm btn-success">View</a>
               </td>
               <?php
                $i++;
                }
