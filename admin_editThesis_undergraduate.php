    ...
    elseif (!is_null($thesisFileToEdit) && is_null($thesisAbstractToEdit)) {
      ...
      if(in_array($thesisFileActualExt, $allowedThesisFileExt))
      {
        if($thesisFileError === 0)
        {
          ...
          echo "You have an error in your file!";
      }
      else
        echo "Invalid File Type! Only ZIP, RAR, AND PDF Extensions are allowed!";
    }
    elseif (is_null($thesisFileToEdit) && !is_null($thesisAbstractToEdit)) {
      if(in_array($thesisAbstractActualExt, $allowedThesisAbstractExt))
      {
        if($thesisAbstractError === 0)
        {
          ...
          echo "You have an error uploading your picture!";
      }
      else
      ...
      <form action="admin_editThesis_undergraduate.php" method="post">
            <table class="table table-bordered" align="center">
              ...
              <tr>
                <td>Thesis Title</td>
                <td>
                  <input type="text" name="edit_txtThesisTitle" class="form-control" value="<?php echo $rowThesisToEdit['thesis_title']; ?>">
                </td>
              </tr>
              <tr>
                <td>Thesis File</td>
                <td>
                  <input type="file" name="edit_flThesisFile">
                </td>
              </tr>
              <tr>
                <td>Year Accomplished</td>
                <td>
                  <input type="text" name="edit_txtThesisYear" class="form-control" value="<?php echo $rowThesisToEdit['year_accomplished']; ?>">
                </td>
              </tr>
              <tr>
                <td>Thesis Abstract</td>
                <td>
                  <input type="file" name="edit_flThesisAbstract">
                </td>
                <td>
