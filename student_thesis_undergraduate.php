  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 text-right">
            <form action="student_thesis_undergraduate.php" method="post">
    ...
    <section class="content container-fluid">
         <table class="table table-bordered" style="width:100%;">
              ...
              -->
                <td>
                  <a href="student_viewThesis_undergraduate.php?thesis_id=<?php echo $rowTheses['thesis_id'];?>" class="btn btn-sm btn-success">View</a>
               </td>
               <?php
                $i++;
                }
