  ...
  include('dbconnect.php');
   if (isset($_POST['addThesis'])) {
    ...
    if((in_array($thesisFileActualExt, $allowedThesisFileExt)) && (in_array($thesisAbstractActualExt, $allowedThesisAbstractExt)))
    {
      ...
      <?php
      echo"<script>location.assign('admin_thesis_doctorate.php')</script>";
        }
  ...
  <!-- Content Wrapper. Contains page content -->
   <div class="content-wrapper">
      ...
      <div class="modal fade" id="modal_addThesis" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="box-body">
                  <form action="admin_thesis_doctorate.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-lg-6 text-right">
      <br>
            <form action="admin_thesis_doctorate.php" method="post">
                <table style="width:100%;">
                    <tr>
   ...
   <div class="box-body">
      <table class="table table-bordered" style="width:100%;">
              ...
              <tr>
                ...
                <td>
                  <a href="admin_editThesis_doctorate.php?thesis_id=<?php echo $rowTheses['thesis_id'];?>" class="btn btn-sm btn-warning">Edit</a>
                  <a href="admin_archiveThesis_doctorate.php?thesis_id=<?php echo $rowTheses['thesis_id'];?>" class="btn btn-sm btn-danger">Archive</a>
                  <a href="admin_viewThesis_doctorate.php?thesis_id=<?php echo $rowTheses['thesis_id'];?>" class="btn btn-sm btn-success">View</a>
               </td>
               <?php
                }
               ?>
