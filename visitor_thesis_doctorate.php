        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
           <li><a href="visitor_thesis_undergraduate.php"><i class="fa fa-graduation-cap"></i> Undergraduate</a></li>
            ...
            <li class="active"><a href="visitor_thesis_doctorate.php"><i class="fa fa-institution"></i> Doctorate</a></li>
          </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 text-right">
          <div class="input">
            <form action="visitor_thesis_doctorate.php" method="post">
    ...
    <section class="content container-fluid">
      <table class="table table-bordered" style="width:100%;">
              ...
              -->
                <td>
                  <a href="visitor_viewThesis_doctorate.php?thesis_id=<?php echo $rowTheses['thesis_id']?>" class="btn btn-sm btn-success">View</a>
               </td>
               <?php
                $i++;
                }
